export class Menu extends Phaser.Scene {
  ...
  create(data) {
    ...
    let nameLabel = this.add.text(250, -50, 'Super Coin Box', { font: '50px Geo', color: '#fff' });
    ...
    let scoreLabel = this.add.text(250, 170, scoreText, { font: '25px Geo', color: '#fff', align: 'center' });
    ...
    let startLabel = this.add.text(250, 260, startText, { font: '25px Geo', color: '#fff' });
